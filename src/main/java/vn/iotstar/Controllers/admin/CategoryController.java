...
import vn.iotstar.models.CategoryModels;
...
public class CategoryController {
    ...
    public String add(Model models) {
        ...
        models.addAttribute("category", categoryModel);
        return "admin/categories/addOrEdit";
    }

    @PostMapping("saveOrUpdate")
    public ModelAndView saveOrUpdate(ModelMap model,
                                     @Valid @ModelAttribute("category") CategoryModels categoryModel, BindingResult result) {
        if (result.hasErrors()) {
    ...
    public ModelAndView edit(ModelMap model, @PathVariable("categoryId") Integer categoryId) {
        ...
        CategoryModels cateModel = new CategoryModels();
